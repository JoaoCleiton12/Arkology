#ifndef _ARKOLOGY_MUMMY5_H_
#define _ARKOLOGY_MUMMY5_H_
...
enum MUMMYSTATE5 { STOPEEDDDDD, UUPPPPP, DOWWNNNNN, LEFFTTTTT, RIGGHTTTTT };

// ---------------------------------------------------------------------------------

class Mummy5 : public Object
{
private:
    Partstatue* part;
...
public:
    uint Sort;
    uint currState = STOPEEDDDDD;            // estado atual do jogador
    uint nextState = DOWWNNNNN;            // próximo estado do jogador

    Mummy5(Partstatue* part);                           // construtor
    ~Mummy5();                          // destrutor
...
inline float Mummy5::Width()
{
    return float(spriteL->Width());
}

inline float Mummy5::Height()
{
