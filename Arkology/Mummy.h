#ifndef _ARKOLOGY_MUMMY_H_
#define _ARKOLOGY_MUMMY_H_
...
public:
    ...
    uint nextState = DOWNN;            // próximo estado do jogador

    Mummy(Partstatue * part);                           // construtor
    ~Mummy();                          // destrutor
