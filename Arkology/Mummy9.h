#ifndef _ARKOLOGY_MUMMY9_H_
#define _ARKOLOGY_MUMMY9_H_
...
enum MUMMYSTATE9 { STOPEEDDDDDDDDD, UUPPPPPPPPP, DOWWNNNNNNNNN, LEFFTTTTTTTTT, RIGGHTTTTTTTTT };

// ---------------------------------------------------------------------------------

class Mummy9 : public Object
{
private:
    Partstatue* part;
...
public:
    uint Sort;
    uint currState = STOPEEDDDDDDDDD;            // estado atual do jogador
    uint nextState = DOWWNNNNNNNNN;            // próximo estado do jogador

    Mummy9(Partstatue* part);                           // construtor
    ~Mummy9();                          // destrutor
...
inline float Mummy9::Width()
{
    return float(spriteL->Width());
}

inline float Mummy9::Height()
{
