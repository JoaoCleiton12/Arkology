#ifndef _ARKOLOGY_MUMMY4_H_
#define _ARKOLOGY_MUMMY4_H_
...
enum MUMMYSTATE4 { STOPEEDDDD, UUPPPP, DOWWNNNN, LEFFTTTT, RIGGHTTTT };

// ---------------------------------------------------------------------------------

class Mummy4 : public Object
{
private:
    Partstatue* part;
...
public:
    uint Sort;
    uint currState = STOPEEDDDD;            // estado atual do jogador
    uint nextState = DOWWNNNN;            // próximo estado do jogador

    Mummy4(Partstatue* part);                           // construtor
    ~Mummy4();                          // destrutor
...
inline float Mummy4::Width()
{
    return float(spriteL->Width());
}

inline float Mummy4::Height()
{
